...
{
    public class ContinuousButton : IItem
    {
        ...
        public ContinuousButton(Rectangle position, AbstractAnimatedSprite sprite, CollisionType collisionType, string message)
        {
